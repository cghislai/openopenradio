 ...
 */
@UnstableApi
public final class WorkaroundHlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
     ...
     */
    public WorkaroundHlsPlaylistParser() {
...
//        long targetDurationUs = C.TIME_UNSET;
        ...
        while (iterator.hasNext()) {
            ...
            if (line.startsWith(TAG_PLAYLIST_TYPE)) {
                ...
                segmentDurationUs = Math.max(0, parseTimeSecondsToUs(line, REGEX_MEDIA_DURATION));
